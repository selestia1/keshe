...
void MainWindow::on_RotateLeftAction_triggered()
{
...
void MainWindow::on_RotateRightAction_triggered()
{
    foreach(QGraphicsItem *item,scene->selectedItems())
    {
        item->setRotation( 30+item->rotation());
...
void MainWindow::on_FrontAction_triggered()
{
...
void MainWindow::on_SaveAction_triggered()
{
    ...
    QString fileName = QFileDialog::getSaveFileName(this,"保存为..","","png 文件(*.png)");
    if(fileName.isEmpty()) return;
